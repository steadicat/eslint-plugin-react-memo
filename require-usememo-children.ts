...
const messages = {
  "object-usememo-children":
    "Object literal should be wrapped in React.useMemo() if used as children",
  "array-usememo-children":
    "Array literal should be wrapped in React.useMemo() if used as children",
  "instance-usememo-children":
    "Object instantiation should be wrapped in React.useMemo() if used as children",
  "jsx-usememo-children":
    "JSX should be wrapped in React.useMemo() when used as children",
  "function-usecallback-children":
    "Function definition should be wrapped in React.useCallback() if used as children",
